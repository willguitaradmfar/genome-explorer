...
const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-start justify-center pt-24">
      <div className="bg-white/20 dark:bg-gray-900/25 backdrop-blur-xl border border-white/15 dark:border-gray-600/20 rounded-lg shadow-2xl w-full max-w-4xl mx-4 overflow-hidden">
        {/* Search Input */}
