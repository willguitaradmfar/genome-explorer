...
const IndicatorPanel: React.FC<IndicatorPanelProps> = ({
  ...
  return (
    <div className="absolute top-20 left-4 z-20">
      <div className="bg-white/20 dark:bg-gray-900/25 backdrop-blur-xl border border-white/15 dark:border-gray-600/20 rounded-lg shadow-2xl w-80 overflow-hidden">
        {/* Header */}
